...
func ParseSPS(data []byte) (self SPSInfo, err error) {
	...
	// Reference: https://github.com/FFmpeg/FFmpeg/blob/master/libavcodec/hevcdec.c#L323
	self.Width = self.Width - self.OutputWindow.LeftOffset - self.OutputWindow.RightOffset
	self.Height = self.Height - self.OutputWindow.TopOffset - self.OutputWindow.BottomOffset
